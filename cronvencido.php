    ...
    if (isset($_POST['posttodos'])) {
        ...
        foreach ($dados as list($nome, $celular, $datavenc, $linhadig, $qrcode)) {
            ...
            if (isset($_POST['posttodos'])) {
				...
				if (!is_file("$dir/logs/" .$month . "/vencido/index.php")) { copy("$dir/logs/.ler/index.php", "$dir/logs/" .$month . "/vencido/index.php"); }
        ...
        if (isset($_POST['posttodos'])) {echo "\n\nFim do envio!\n\n";}
			...
			0 9 * * * curl -X POST -F 'posttodos=1' http://admin:suasenha@127.0.0.1/mkmsg/cronvencido.php > /dev/null 2>&1";}
?>